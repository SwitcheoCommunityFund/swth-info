 ...
 */
export declare function getTokenBalance(url: string | rpc.RPCClient, scriptHash: string, address: string): Promise<u.Fixed8>;
/**
 ...
 */
export declare function getTokenBalances(url: string | rpc.RPCClient, scriptHashArray: string[], address: string): Promise<{
 ...
 */
export declare function getToken(url: string | rpc.RPCClient, scriptHash: string, address?: string): Promise<TokenInfo>;
/**
 ...
 * @param address Optional address to query the balance for. If provided, the returned object will include the balance property.
 */
export declare function getTokens(url: string | rpc.RPCClient, scriptHashArray: string[], address?: string): Promise<TokenInfo[]>;
