...
function NumberParser(item) {
    switch (item.type) {
        ...
        case "ByteArray":
            return u.Fixed8.fromReverseHex(item.value);
        default:
            throw new Error(`Received invalid type ${item.type}`);
    }
}
const parseTokenInfo = rpc.buildParser(rpc.StringParser, rpc.StringParser, rpc.IntegerParser, NumberParser);
const parseTokenInfoAndBalance = rpc.buildParser(rpc.StringParser, rpc.StringParser, rpc.IntegerParser, NumberParser, NumberParser);
/**
