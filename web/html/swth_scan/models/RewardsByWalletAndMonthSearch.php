...
/**
 * RewardsByWalletAndMonthSearch represents the model behind the search form of `app\models\RewardsByWalletAndMonth`.
 */
class RewardsByWalletAndMonthSearch extends RewardsByWalletAndMonth
{
    ...
    {
        return [
            [['wallet', 'month', 'varEmptyValues', 'varPreciseValues','denom'], 'safe'],
            [['value'], 'number'],
    ...
    {
        $query = RewardsByWalletAndMonth::find();
