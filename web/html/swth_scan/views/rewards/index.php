...
$reward_tr_types = Rewards::find()->select('tr_type')->distinct()->asArray()->all();
$reward_tr_types = array_column($reward_tr_types,'tr_type','tr_type');
...
<div class="rewards-index">
    ...
    <div class="row" id="charts_placement">
        <?php
            echo $this->render('//charts/day-month',[
                'charts-controller'=>'rewards',
                'show_series'=>['swth'],
                'params'=>['wallet'=>@$_GET['RewardsSearch']['wallet']]
            ]);
        ?>
    </div>
    ...
    $columns = [
        ...
        [
            ...
            'format'=>'raw',
            'value'=>function($data){
                if(@$data->v->name==null) return null;
