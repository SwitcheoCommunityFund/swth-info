...
/*echo 'unbonded_this_month : ';
echo $unbonded_this_month;
echo '<br>';
echo 'unbonded_this_week : ';
echo $unbonded_this_week;
echo '<br>';
echo 'unbonding_in_future : ';
echo $unbonding_in_future;
echo '<br>';
echo 'rewards_generated_this_week : ';
echo $rewards_generated_this_week;
echo '<br>';
echo 'rewards_generated_this_month : ';
echo $rewards_generated_this_month;
echo '<br>';
echo 'withdrawals_this_month : ';
var_dump($withdrawals_this_month);
echo '<br>';
echo 'withdrawals_this_week : ';
var_dump($withdrawals_this_week);
echo '<br>';
echo 'deposits_this_month : ';
var_dump($deposits_this_month);
echo '<br>';
echo 'deposits_this_week : ';
var_dump($deposits_this_week);
echo '<br>';*/
...
echo "<script>console.log('".json_encode($tokens)."');</script>";
...
$js = <<< JS
    ...
    function generateDenomTable(data,d='denom',v='value',enc=true,prsf=false)
    {
        ...
        for(var i in data){
            ...
            var tr = $("<tr>")
                .append($('<td>').attr({class:'bc_name'}).append($('<img>').attr({class:'token_img',src:'/img/tokens/'+token_props.image})).append(row[d]))
